...
urlpatterns = [
    ...
    path('store/',include(('store.urls', 'store'),namespace='store')), # store
    path('resource/',include(('resource.urls', 'resource'),namespace='resource')), # resource
    path('robots.txt', robots, name='robots'), # robots
    path('sitemap.xml', sitemap, {'sitemaps': sitemaps,'template_name':'sitemap/sitemap.xml'}, name='django.contrib.sitemaps.views.sitemap'), # 网站地图
