...
class ItemAdmin(admin.ModelAdmin):
    ...
    list_display = ('id', 'title', 'author', 'create_date', 'update_date', 'price', 'views', 'sales', 'is_top')
...
class OrderAdmin(admin.ModelAdmin):
    ...
    # 在查看修改的时候显示的属性，第一个字段带有<a>标签，所以最好放标题
    list_display = ('id', 'uid', 'good', 'user', 'create_date', 'is_confirmed', 'realPrice','pay_type')

    # 设置需要添加<a>标签的字段
    list_display_links = ('uid',)

    # 激活过滤器，这个很有用
    list_filter = ('create_date', 'user', 'good', 'pay_type')
